  ...
  return (
    <div className="relative">
      ...
      <div className="relative group">
        ...
        {/* Platform Buttons Integration as requested */}
        <div className={`mt-4 flex justify-center gap-4 transition-all duration-300 ${isHovered ? 'opacity-100' : 'opacity-60'}`}>
          <button className="p-2 bg-[#1DB954] rounded-full hover:scale-110 transition-transform">
             <Image src="https://upload.wikimedia.org/wikipedia/commons/1/19/Spotify_logo_without_text.svg" alt="Spotify" width={20} height={20} />
          </button>
          <button className="p-2 bg-[#FF0000] rounded-full hover:scale-110 transition-transform">
          ...
          <button className="p-2 bg-[#fa243c] rounded-full hover:scale-110 transition-transform">
             <Image src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" alt="Apple Music" width={20} height={20} className="invert" />
          </button>
        </div>
      </div>
    </div>
